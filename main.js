...
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
	...
	DogeXeonOP.browserDescription = [ 'Fazrin Ezz', 'chrome', '3.0' ]
    DogeXeonOP.on('qr', () => {
    ...
    DogeXeonOP.sendMessage(`6283110011351@s.whatsapp.net`, `Thanks bro, your bot is working on my whatsapp number ez😂`, MessageType.extendedText)
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      try {
        ...
        DogeXeonOP.sendMessage(anu.jid, "Hello everyone, am Xdit Bot, ready to help you here ㋛︎", "conversation")
      }
      ...
      welcomeButt = { contentText: `${teks}`, footerText: `Xdit BOT`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `Xdit BOT`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
